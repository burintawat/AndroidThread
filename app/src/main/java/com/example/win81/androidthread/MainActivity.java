package com.example.win81.androidthread;
    ...
    private void show1() throws IOException {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    url = new URL("https://img.youtube.com/vi/33Ju1rKiTGo/0.jpg");
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_click2:
                new LoadImageTask().execute("https://pbs.twimg.com/profile_images/1694018696/eieikam.jpg");
                break;
        }
    }
}
